            ...
            <Card key={i} className="lg:w-[85%] w-[95%] p-4 pb-2 flex flex-col relative">
              <div className="flex">
                ...
                <CardHeader className="px-2 py-0 ">
                  <p className="text-[10px] md:text-xs whitespace-nowrap text-muted-foreground">Order Date: 01/01/25</p>
              ...
              <CardContent className="p-0 pt-3 text-[10px] md:text-xs flex w-full gap-2 justify-around">
                <p className="text-center">Delivery Status: Enroute</p>
                <p className="text-center">Payment Status: Completed</p>
                <p className="text-center">Amount: ₹500</p>
              </CardContent>

              {/* top-right div in card */}
              <div className="absolute top-4 md:top-3 right-1 md:right-4 text-[10px] md:text-xs flex items-center">
                <p className="text-muted-foreground">Product id: 1234</p>
                <DropdownMenu>
